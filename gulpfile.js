...
export const build = gulp.series(reset, files, revision);
export const deployZIP = gulp.series(reset, files, revision, zip);
export const deployFTP = gulp.series(reset, files, revision, ftp);
